...
document.write('	<a href="../Humidification/IndustrialAppIntro.htm">工业</a>');
...
document.write('  <div>');
document.write('    <a href="../DustOdorControl/OverView.htm">概况</a>');
document.write('	<span class="qmdivider qmdividerx" ></span>');
document.write('	<span class="qmtitle" >应用领域</span>');
...
document.write('  </div>');
document.write('  <span class="qmdivider qmdividery" ></span>');
document.write('  <a href="javascript:void(0);">户外降温</a>');
document.write('  <div>');
document.write('    <a href="../OutdoorCooling/Residential.htm">家居住宅</a>');
...
document.write('  <span class="qmdivider qmdividery" ></span>');
document.write('  <a href="http://www.microcool.com/about/index.htm">我们的服务</a>');
document.write('  <div>');
